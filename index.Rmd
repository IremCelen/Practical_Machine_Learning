...
Based on the results, random forest and boosted trees give a high accuracy. Since random forest has already given a very high accuracy, the models will not be combined for achieving a better accuracy, and this method will be used as the final model.
